...
Most of this is client work in private repos, so the table is the index and the live links are
the proof.
...
| **HI Dog Maps** | Interactive map of dog-friendly places on Oʻahu. No API keys, no build step. | MapLibre GL · vanilla JS | [Repo](https://github.com/shaunagits/hi-dog-maps) · [Live](https://shaunagits.github.io/hi-dog-maps/) |
| **This portfolio** | Source for shauna.digital, tokenized design system and decision docs included. | Astro | [Repo](https://github.com/shaunagits/portfolio-2026) · [Live](https://shauna.digital) |
...
[shauna.digital](https://shauna.digital) · [alohaanimaloutreach.org](https://alohaanimaloutreach.org)
